...
@Component({
  selector: 'app-prueba-grafica',
  templateUrl: './prueba-grafica.component.html',
  styleUrls: ['./prueba-grafica.component.css']
})
export class PruebaGraficaComponent implements OnChanges {
